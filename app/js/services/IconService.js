...
/**
 * Icon service for managing SVG icons.
 * Provides inline SVG icons without external dependencies.
 */
export class IconService extends Module {
  constructor(options = {}) {
    super(options);
  ...
  getIcon(name, size = 16) {
    const svg = this.icons[name] || this.icons['terminal'];
  ...
  createIcon(name, size = 16) {
    ...
    div.innerHTML = this.getIcon(name, size);
